...
const About = () => {
  return (
    <div className="py-16 px-10 bg-gradient-to-b from-white to-gray-100">
      <div className="flex flex-col gap-10 md:flex-row items-center justify-center">
        <Image
          ...
          alt="about image"
        />
        <div className="flex flex-col items-center md:items-start w-1/2 px-10">
          <h1 className="text-mGreen text-2xl font-bold">About Us</h1>
          <h1 className="text-3xl font-bold mt-2">
            We Fuel Curious Minds and Provide a Platform to Thrive
          </h1>
          <p className="text-gray-500 text-justify text-lg mt-6">
